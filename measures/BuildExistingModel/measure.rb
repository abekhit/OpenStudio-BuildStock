...
class BuildExistingModel < OpenStudio::Measure::ModelMeasure
  ...
  def arguments(model)
    ...
    buildstock_csv = OpenStudio::Measure::OSArgument.makeStringArgument("buildstock_csv", true)
    buildstock_csv.setDisplayName("Name of sample file")
    buildstock_csv.setDescription("The name of the file containing the samples.")
    buildstock_csv.setDefaultValue("buildstock.csv")
    args << buildstock_csv
  ...
  def run(model, runner, user_arguments)
    ...
    buildstock_csv = runner.getStringArgumentValue("buildstock_csv",user_arguments)
    ...
    buildstock_csv = File.absolute_path(File.join(characteristics_dir, buildstock_csv)) # Should have been generated by the Worker Initialization Script (run_sampling.rb) or provided by the project
