...
def copy_other_measures(beopt_measures_dir)
  ...
  other_measures = ["TimeseriesCSVExport", "ResidentialSimulationControls", "ThermalCapacitanceReport", "UAReport"] # Still under development: "UtilityBillCalculationsSimple", "UtilityBillCalculationsDetailed"
