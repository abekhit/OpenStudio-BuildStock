...
def copy_other_measures(beopt_measures_dir)
  ...
  other_measures = ["TimeseriesCSVExport", "ResidentialSimulationControls", "ConstructionPropertiesReport"] # Still under development: "UtilityBillCalculationsSimple", "UtilityBillCalculationsDetailed"
